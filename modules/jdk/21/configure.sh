...
alternatives --set java /usr/lib/jvm/temurin-21-jdk/bin/java
alternatives --set javac /usr/lib/jvm/temurin-21-jdk/bin/javac

# Update securerandom.source for quicker starts (must be done after removing jdk 8, or it will hit the wrong files)
JAVA_SECURITY_FILE=/usr/lib/jvm/temurin-21-jdk/conf/security/java.security
