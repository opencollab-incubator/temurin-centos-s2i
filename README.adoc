# Source To Image (S2I) image for OKD and Red Hat OpenShift providing Eclipse Temurin Java

These are the OpenJDK Source to Image (S2I) images for OKD and Red Hat OpenShift.
